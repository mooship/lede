...
|---|---|
| The Tidel web app (`tidel.app`, `tidel.timothybrits.co.za`, `lede.timothybrits.co.za`) | Third-party news sources linked from the site |
...
Once a fix is deployed, we're happy to credit you in the release notes if you'd like.
