...
6. Summarise — `Promise.all` → Anthropic `claude-haiku-4-5-20251001` if `ANTHROPIC_API_KEY` set, else raw RSS description. 150–250 words, British English. Curation uses `claude-sonnet-4-6`.
