...
ALTER TABLE "stories" DROP CONSTRAINT "stories_link_edition_unique";
--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "stories_summary_trgm_idx" ON "stories" USING gin (summary gin_trgm_ops);
